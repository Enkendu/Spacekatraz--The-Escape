...
public class BossFiring : MonoBehaviour {
	...
	void fireWeapon()
	{
		if (Time.time > nextFire) 
		{
			...
			newClone.transform.position = newClone.transform.position-(newClone.transform.forward+newClone.transform.localScale);
			...
			newClone.transform.localScale = newClone.transform.localScale*2;
